...
import { userCancelRegisterAction, userConfirmRegisterAction } from "../Redux/Actions/userActions";
...
export const ConfirmRegister = ({ location, history }) => {
  ...
  const handleCancel = () => {
    dispatch(userCancelRegisterAction(emailVerificationToken.toString(), history));
  };
  return (
    <>
      <Toast />
        ...
        <div className=" d-flex">
          ...
          >
            ...
            <form className="box-right text-center py-2 px-2 w-50">
              ...
              <div className="p-5">
                <button type="button" className="btn btn-outline text-uppercase px-3 py-2" onClick={handleCancel}>
                  cancel
                </button>
                <img
                  style={{
                  ...
                  alt=""
                />
                <button type="button" className="btn btn-success text-uppercase px-3 py-2" onClick={handleConfirm}>
                  accept
                </button>
              </div>
            </form>
